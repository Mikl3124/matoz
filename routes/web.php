...
Route::group([
	...
	Route::group([
		...
		PANEL::resource('categories/{catId}/custom_fields', 'CategoryFieldController');
		...
		PANEL::resource('custom_fields', 'FieldController');
		PANEL::resource('custom_fields/{cfId}/options', 'FieldOptionController');
		PANEL::resource('custom_fields/{cfId}/categories', 'CategoryFieldController');
